...
const places = [
    {
        ...
        descricao: 'Ótima opção para tomar um brunch, almoçar, tomar um café da tarde ou jantar, além de levar pães e doces deliciosos para casa. Possui uma área externa coberta onde os pets podem ficar.'  
    },
    {
    ...
    },
    {
        ...
        cep: '12450-000',
        categoria: 'restaurantes',
        descricao: 'O Restaurante possui um espaço aberto super gostoso para os pets ficarem à vontade. Servem massas, risotos, carnes e saladas. O destaque fica por conta da Picanha Argentina super macia ... derrete na boca, além do atendimento super amigável com pets e estacionamento gratuito.'  
    },{
        ...
        cep: '04707-900',
        categoria: 'restaurantes',
        descricao: 'Esta hamburgueria localizada no Shopping Morumbi (possui outros endereços também) tem ótimos hamburgueres e possui opções veganas e vegetarianas. Logo na entrada deixam um potinho de agua para os pets e vendem um biscoito para pets com o lucro revertido para ONGs que trabalham para ajudar a vida de muitos cachorros.'  
    },
    {
